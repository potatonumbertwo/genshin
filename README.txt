...
'''
run python to download the images python 3.10 above
'''

python download_images_from_google.py --urls urls.txt --output images/
albedo


'''
pip install labelimg on python 3.9
